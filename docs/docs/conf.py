...
# workflow-manager build configuration file
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/workflow_manager/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/workflow_manager",
    ...
    "repository_url": "https://github.com/collective/workflow_manager",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/workflow_manager/edit/main/docs/",
# }
...
ogp_site_name = "workflow-manager Documentation"
ogp_type = "website"
...
htmlhelp_basename = "workflow-managerDocumentation"
...
latex_documents = [
    (
        "index",
        "workflow-managerDocumentation.tex",
